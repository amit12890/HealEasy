...
public class DatePickerDialog extends Dialog {
    ...
    public static int primaryColor,secondaryColor;
    ...
    private class DatePickerLayout extends FrameLayout implements DatePicker.OnDateChangedListener, YearPicker.OnYearChangedListener {
        ...
        public int mHeaderPrimaryColor;
        ...
        public void applyStyle(int resId){
            ...
            mHeaderPrimaryColor = primaryColor;
            mHeaderSecondaryColor= secondaryColor;
    ...
    public static class Builder extends Dialog.Builder implements OnDateChangedListener {
        ...
        public Builder(int styleId,int pColor, int sColor){
            super(styleId);
            ...
            mMaxMonth = mMonth;
            mMaxYear = mYear + 12;
            DatePickerDialog.primaryColor = pColor ;
            DatePickerDialog.secondaryColor = sColor;
        ...
        public Builder(int styleId){
            ...
            mMaxMonth = mMonth;
            mMaxYear = mYear + 12;
            DatePickerDialog.primaryColor = 1 ;
